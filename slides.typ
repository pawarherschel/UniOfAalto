...
#show heading.where(depth: 3) : set heading(
  numbering: (..n) => "=" * 3
)
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Highlights]
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== #link("https://github.com/pawarherschel/CovUniGJ2024")[Coventry University's Summer School Game Jam]]]
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== #link("https://github.com/pawarherschel/GMTK2023")[GMTK's 2023 Game Jam]]]
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== Bevy]
  #align(left)[
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Other Technical Projects]]

#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[
...
#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== #link("https://github.com/pawarherschel/booth_archiver")[Booth Archiver]]

  #align(left)[
    #text(fill: white, size: 28pt)[
      #enum(numbering: (.., n) => text(stroke: white)[#n.])[Manually Maintained Excel Sheet][Power Automate][Python][Rust Single Threaded][Multithreading]
    ]
  ]
]

#focus-slide(theme: "blue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Creative exploration]]

#for title in (
  "Photoshop",
  "Pixel Art and Vector Graphics",
) {
  focus-slide(theme: "lblue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== #title]]
}
...
#focus-slide(theme: "lblue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[== Scanlation]]
...
#focus-slide(theme: "lblue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Background]]

#focus-slide(theme: "dblue", show-counter: false)[
  #text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%, size: 42pt, fill: rgb("#00000077"))[#smallcaps[This Page Has Been Intentionally Left Blank]]
]

#focus-slide(theme: "lblue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Why Aalto?]]

#focus-slide(theme: "lblue", show-counter: false)[#text(font: "NotoSerif NF", style: "italic", weight: "light", stretch: 70%,)[= Conclusion]]
